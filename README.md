...
<p>The quotes are randomly chosen from a determined list of quotes in the database. The user can switch tabs by clicking <i>"All Quotes"</i> to see the full list of quotes in the database (sorted by author alphabetically). The user can also delete a particular quote from the list.</p>
...
<p>By clicking the button <i>Add A New Quote</i>, a modal will appear where the user can enter the information necessary and add a quote to the list.</p>
<img width="1440" alt="Screen Shot 2021-05-06 at 5 12 37 PM" src="https://user-images.githubusercontent.com/64567338/117366101-43bd4a80-ae8e-11eb-8c95-243b5c87184f.png">
